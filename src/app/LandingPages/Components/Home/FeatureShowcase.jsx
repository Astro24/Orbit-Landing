...
export default function FeatureShowcase() {
    return (
        <section className="relative left-1/2 right-1/2 ml-[-50vw] mr-[-50vw] w-[100vw] overflow-hidden bg-gradient-to-r from-[#E6F4F1] to-[#E8EEFB] py-16 px-6 md:px-12">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                
                <div className="flex flex-col gap-6">
                    <h2 className="font-bold text-4xl md:text-5xl text-[#1D2130] leading-tight max-w-md">
