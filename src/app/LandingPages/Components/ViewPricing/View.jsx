...
export default function View() {
    return (
        <div className="flex justify-center items-center bg-[#F7F8FC] rounded-2xl p-10">
        <div className="card justify-center items-center text-center w-full max-w-4xl rounded-2xl p-4 sm:p-6 lg:p-10 bg-[#F7F8FC]">
